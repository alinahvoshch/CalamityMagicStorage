...
using CalamityMagicStorage.Components;

namespace CalamityMagicStorage.Components
{
    public class TECalamityStorageUnit : TEStorageUnit
    {
        ...
        internal static void SwapItems(TECalamityStorageUnit unit1, TECalamityStorageUnit unit2)
        {
        ...
        internal bool FlattenFrom(TECalamityStorageUnit source, out List<Item> transferredItems)
        {
            transferredItems = null;

            if (Main.netMode == NetmodeID.MultiplayerClient)
            {
                NetHelper.ClientRequestItemTransfer((TEStorageUnit)this, (TEStorageUnit)source);
                return false;
            }
        ...
        internal static void AttemptItemTransfer(TECalamityStorageUnit destination, TECalamityStorageUnit source, out List<Item> transferredItems)
        {
        ...
        public override void NetReceive(BinaryReader trueReader)
        {
            ...
            if (opCount > 0)
            {
                if (ByPosition.TryGetValue(Position, out TileEntity te) && te is TECalamityStorageUnit otherUnit)
                {
